...
@section('content')
  ...
  <section class="relative py-10 stripe-bg">
    ...
    <h1 class="text-2xl font-semibold text-primary mb-6">Edit Organisasi</h1>

    <form action="{{ route('admin.organization.update', $item) }}" method="post" enctype="multipart/form-data" class="space-y-4">
      @csrf
      @method('PATCH')
      <div>
