@extends('layouts.app')
@section('title','Buat Sekbid')
@section('content')

  <section class="max-w-3xl mx-auto px-4 py-10">
    <h1 class="text-2xl font-semibold text-primary mb-6">Buat Sekbid</h1>

    <form action="{{ route('admin.sekbid.store') }}" method="post" enctype="multipart/form-data" class="space-y-4">
      @csrf
      <div>
