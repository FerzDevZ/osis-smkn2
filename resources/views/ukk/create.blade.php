@extends('layouts.app')
@section('title','Buat UKK')
@section('content')

  <section class="relative py-10 stripe-bg">
    <div class="max-w-3xl mx-auto px-4">
    <h1 class="text-2xl font-semibold text-primary mb-6">Buat UKK</h1>

    <form action="{{ route('admin.ukk.store') }}" method="post" enctype="multipart/form-data" class="space-y-4">
      @csrf
      <div>
